                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">
                                <h3 class="text-light mb-0">Prendre contact avec nous</h3>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-geo-alt text-primary me-2"></i>
                                <p class="mb-0">{{ $entreprise->address ?? '123 Street, New York, USA' }}</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">{{ $entreprise->email ?? 'info@example.com' }}</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">{{ $entreprise->phone ?? '+012 345 67890' }}</p>
                            </div>
                            <div class="d-flex mt-4">
                                    @if ($socials->isNotEmpty())
                                        @foreach ($socials as $social)
                                            <a class="btn btn-primary btn-square me-2" href="{{ $social->url }}" target="_blank">
             ...
             {{--                    <a class="btn btn-primary btn-square me-2" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="{{ route('actualites') }}"><i class="bi bi-arrow-right text-primary me-2"></i>Actualités</a>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                <a class="text-light mb-2" href=""><i class="bi bi-arrow-right text-primary me-2"></i>Politique de confidentialité</a>
                                <a class="text-light mb-2" href=""><i class="bi bi-arrow-right text-primary me-2"></i>Conditions d'utilisation</a>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="https://mabanniere.cd">MA BANNIERE</a>. Tout droit réservé. 
